        ...
        <div className="relative aspect-video bg-gradient-to-r from-black/50 grid grid-cols-2 items-center gap-base transition-all rounded-md border overflow-hidden">
            ...
            <div className="relative p-sm">
                ...
                <div className="hidden lg:block">
                    <p className="my-sm line-clamp-3 text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita consequatur sed provident porro dolore quia accusantium molestias dolor maxime quis, harum fugit ad obcaecati quos repellat itaque similique magni iusto possimus culpa deserunt.</p>
                </div>
